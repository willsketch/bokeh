...
class HoverTool(InspectTool):
    ...
    *toolbar icon* shown above.
    ...
    formatters = Dict(String, Either(Enum(TooltipFieldFormatter), Instance(CustomJSHover)), default=dict, help="""
...
Tool.register_alias("tap", TapTool)
Tool.register_alias("doubletap", lambda: TapTool(gesture="doubletap"))
Tool.register_alias("crosshair", CrosshairTool)
Tool.register_alias("box_select", BoxSelectTool)
...
Tool.register_alias("poly_select", PolySelectTool)
Tool.register_alias("lasso_select", LassoSelectTool)
...
Tool.register_alias("save", SaveTool)
Tool.register_alias("copy", CopyTool)
Tool.register_alias("undo", UndoTool)
Tool.register_alias("redo", RedoTool)
Tool.register_alias("reset", ResetTool)
Tool.register_alias("help", HelpTool)
Tool.register_alias("examine", ExamineTool)
Tool.register_alias("fullscreen", FullscreenTool)
Tool.register_alias("box_edit", BoxEditTool)
Tool.register_alias("line_edit", LineEditTool)
Tool.register_alias("point_draw", PointDrawTool)
Tool.register_alias("poly_draw", PolyDrawTool)
Tool.register_alias("poly_edit", PolyEditTool)
Tool.register_alias("freehand_draw", FreehandDrawTool)
